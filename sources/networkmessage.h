...
class NetworkMessage
{
	public:
		...
		void addItem(uint16_t id, uint8_t count, bool useReplacement);
		void addItem(const Item* item, bool useReplacement);
		void addItemId(uint16_t itemId, bool useReplacement);
