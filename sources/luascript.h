...
class LuaInterface
{
	...
	protected:
		...
		//lua functions
		static int32_t luaIsDll(lua_State* L);
		...
		static int32_t luaGetPlayerFPS(lua_State* L);
		static int32_t luaGetPlayerLocalPing(lua_State* L);
		...
		static int32_t luaGetItemDuration(lua_State* L);
