...
bool ConfigManager::load()
{
	...
	m_confString[BLOCKEDID_AUTOLOOT] = getGlobalString("blockedIds_autoloot", "");
	m_confString[MONEYID_AUTOLOOT] = getGlobalString("moneyIds_autoloot", "2160;2148;2152;9971");
	m_confNumber[AUTOLOOT_LIMITITEM] = getGlobalNumber("limitItems_autoloot", 100);
